...
var _user$project$Scroll$inRange = F3(
	function (value, min, max) {
		return (_elm_lang$core$Native_Utils.cmp(min, value) < 1) && (_elm_lang$core$Native_Utils.cmp(value, max) < 1);
	});
var _user$project$Scroll$onOverlap = F4(
	function (min, max, update, _p0) {
		var _p1 = _p0;
		return (A3(_user$project$Scroll$inRange, _p1._0, min, max) || A3(_user$project$Scroll$inRange, _p1._1, min, max)) ? _elm_lang$core$Maybe$Just(update) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Scroll$onInRange = F4(
	function (min, max, update, _p2) {
		var _p3 = _p2;
		return A3(_user$project$Scroll$inRange, _p3._1, min, max) ? _elm_lang$core$Maybe$Just(update) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Scroll$handle = F3(
...
var _user$project$Scroll$Down = {ctor: 'Down'};
var _user$project$Scroll$Up = {ctor: 'Up'};
var _user$project$Scroll$direction = function (_p8) {
	var _p9 = _p8;
	return (_elm_lang$core$Native_Utils.cmp(_p9._0, _p9._1) < 0) ? _user$project$Scroll$Down : _user$project$Scroll$Up;
};
var _user$project$Scroll$crossing = F2(
	function (line, _p10) {
		var _p11 = _p10;
		var _p13 = _p11._1;
		var _p12 = _p11._0;
		...
		return crossed ? _elm_lang$core$Maybe$Just(
			_user$project$Scroll$direction(
				{ctor: '_Tuple2', _0: _p12, _1: _p13})) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Scroll$onCrossUp = F3(
	function (line, update, move) {
		var direction = A2(_user$project$Scroll$crossing, line, move);
		var _p14 = direction;
...
var _user$project$Scroll$onCrossDown = F3(
	function (line, update, move) {
		var direction = A2(_user$project$Scroll$crossing, line, move);
		var _p15 = direction;
...
var _user$project$Scroll$onCrossOver = F3(
	function (line, update, move) {
		var direction = A2(_user$project$Scroll$crossing, line, move);
		return A2(
...
var _user$project$Scroll$onUp = F2(
	function (update, move) {
		var _p17 = _user$project$Scroll$direction(move);
		if (_p17.ctor === 'Up') {
			return _elm_lang$core$Maybe$Just(update);
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Scroll$onDown = F2(
	function (update, move) {
		var _p18 = _user$project$Scroll$direction(move);
		if (_p18.ctor === 'Down') {
			return _elm_lang$core$Maybe$Just(update);
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$Actions$Model = F4(
	function (a, b, c, d) {
		return {style: a, defaultStyle: b, lastPostion: c, info: d};
	});
var _user$project$Actions$Animate = function (a) {
	return {ctor: 'Animate', _0: a};
};
var _user$project$Actions$Grow = {ctor: 'Grow'};
var _user$project$Actions$Shrink = {ctor: 'Shrink'};
var _user$project$Actions$Header = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Ports$scroll(_user$project$Actions$Header),
				A2(
				_mdgriffith$elm_style_animation$Animation$subscription,
				_user$project$Actions$Animate,
				_elm_lang$core$Native_List.fromArray(
					[model.style]))
			]));
};
var _user$project$Main$setDirection = F2(
...
var _user$project$Main$update = F2(
	function (action, model) {
		...
		switch (_p2.ctor) {
			case 'Grow':
				var midModel = A2(_user$project$Main$setDirection, 'grow', model);
				var style = A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_mdgriffith$elm_style_animation$Animation$easing(
								{
									duration: 2 * _elm_lang$core$Time$second,
									ease: function (x) {
										return Math.pow(x, 2);
									}
								}),
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_mdgriffith$elm_style_animation$Animation$px(200))
								]))
						]),
					_mdgriffith$elm_style_animation$Animation$style(
						_elm_lang$core$Native_List.fromArray(
							[
								_mdgriffith$elm_style_animation$Animation$height(
								_mdgriffith$elm_style_animation$Animation$px(90))
							])));
			...
			case 'Shrink':
				var midModel = A2(_user$project$Main$setDirection, 'shrink', model);
				var style = A2(
					_mdgriffith$elm_style_animation$Animation$queue,
					_elm_lang$core$Native_List.fromArray(
						[
			...
			default:
				var _p4 = _p2._0;
				var _p3 = A2(_elm_lang$core$Debug$log, 'move', _p4);
				var previous = _p3._0;
				var current = _p3._1;
				var newModel = function () {
					var infoB = model.info;
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							info: _elm_lang$core$Native_Utils.update(
								infoB,
								{previousValue: previous, currentValue: current, delta: previous - current})
						});
				}();
				return A3(
					_user$project$Scroll$handle,
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							_user$project$Scroll$onCrossDown,
							400,
							_user$project$Main$update(_user$project$Actions$Grow)),
							A2(
							_user$project$Scroll$onCrossUp,
							400,
							_user$project$Main$update(_user$project$Actions$Shrink))
						]),
					_p4,
					newModel);
		}
	});
var _user$project$Main$defaultStyles = _mdgriffith$elm_style_animation$Animation$style(
	_elm_lang$core$Native_List.fromArray(
		[
			_mdgriffith$elm_style_animation$Animation$width(
			_mdgriffith$elm_style_animation$Animation$percent(100)),
			_mdgriffith$elm_style_animation$Animation$backgroundColor(_elm_lang$core$Color$lightRed)
		]));
var _user$project$Main$initialModel = {
	...
	defaultStyle: _user$project$Main$defaultStyles,
	lastPostion: 90.0,
	info: {previousValue: 0.0, currentValue: 0.0, delta: 0.0, direction: ''}
};
...
var _user$project$Main$view = function (model) {
	var styles = A2(
		...
		A2(
			...
			_mdgriffith$elm_style_animation$Animation$render(_user$project$Main$defaultStyles)));
	var info = model.info;
	return A2(
			...
			[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'direction: ',
									_elm_lang$core$Basics$toString(info.direction)))
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'previousValue: ',
									_elm_lang$core$Basics$toString(info.previousValue)))
							])),
						A2(
						_elm_lang$html$Html$h3,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									'currentValue: ',
									_elm_lang$core$Basics$toString(info.currentValue)))
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'height', _1: '10000px'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
